...
import 'package:finvoras_gen_core/generators/generator_helper.dart';
import 'package:finvoras_gen_core/generators/integrations/image_integration.dart';
import 'package:finvoras_gen_core/generators/integrations/integration.dart';
import 'package:finvoras_gen_core/generators/integrations/lottie_integration.dart';
import 'package:finvoras_gen_core/generators/integrations/rive_integration.dart';
import 'package:finvoras_gen_core/generators/integrations/svg_integration.dart';
import 'package:finvoras_gen_core/settings/config.dart';
import 'package:finvoras_gen_core/settings/flavored_asset.dart';
import 'package:finvoras_gen_core/settings/pubspec.dart';
import 'package:finvoras_gen_core/utils/error.dart';
import 'package:finvoras_gen_core/utils/string.dart';
...
List<FlavoredAsset> _getAssetRelativePathList(
  ...
  /// List of globs as provided the `finvoras_gen -> assets -> exclude`
  /// section in the pubspec.yaml.
  List<Glob> excludes,
) {
  // Normalize.
