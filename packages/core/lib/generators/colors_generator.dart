...
import 'package:finvoras_gen_core/settings/color_path.dart';
import 'package:finvoras_gen_core/settings/pubspec.dart';
import 'package:finvoras_gen_core/utils/color.dart';
...
String generateColors(
  ...
  if (colorsConfig.inputs.isEmpty) {
    throw const InvalidSettingsException(
      'The value of "finvoras_gen/colors:" is incorrect.',
    );
  }
