...
import 'package:flutter_gen_v2_core/settings/color_path.dart';
import 'package:flutter_gen_v2_core/settings/pubspec.dart';
import 'package:flutter_gen_v2_core/utils/color.dart';
...
String generateColors(
  ...
  if (colorsConfig.inputs.isEmpty) {
    throw const InvalidSettingsException(
      'The value of "flutter_gen_v2/colors:" is incorrect.',
    );
  }
