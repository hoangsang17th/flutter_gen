...
void main() {
  ...
  group('Test FlutterGenerator', () {
    ...
    test('Only flutter_gen_v2 value', () async {
      const pubspec = 'test_resources/pubspec_only_flutter_gen_v2_value.yaml';
      const assets = 'pubspec_only_flutter_gen_v2_value_assets.gen.dart';
      const colors = 'pubspec_only_flutter_gen_v2_value_colors.gen.dart';
      const fonts = 'pubspec_only_flutter_gen_v2_value_colors.gen.dart';
