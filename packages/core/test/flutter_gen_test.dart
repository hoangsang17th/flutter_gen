...
void main() {
  ...
  group('Test FlutterGenerator', () {
    ...
    test('Only finvoras_gen value', () async {
      const pubspec = 'test_resources/pubspec_only_finvoras_gen_value.yaml';
      const assets = 'pubspec_only_finvoras_gen_value_assets.gen.dart';
      const colors = 'pubspec_only_finvoras_gen_value_colors.gen.dart';
      const fonts = 'pubspec_only_finvoras_gen_value_colors.gen.dart';
